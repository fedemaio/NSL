...
double Random :: Distance(double x1, double x2, double y1, double y2){
   //This function calculates the distance in 2-dimensions
...
double Random :: Lorentzian (double mu, double Lambda){
   // This function generates a random number from a Cauchy-Lorentz distribution with given mu and Lambda
   double y=Rannyu();
   return Lambda*tan(M_PI*(y-0.5))+ mu;
}
