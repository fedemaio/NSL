  ...
  if (input.is_open()){
    while ( !input.eof() ){
      ...
      if( property == "POTENTIAL_ENERGY" ){
        ofstream coutp("../OUTPUT/potential_energy_solid.dat");
        ...
        ofstream coutk("../OUTPUT/kinetic_energy_solid.dat");
        ...
        ofstream coutt("../OUTPUT/total_energy_solid.dat");
        ...
        ofstream coutte("../OUTPUT/temperature_solid.dat");
        ...
        ofstream coutpr("../OUTPUT/pressure_solid.dat");
...
void System :: averages(int blk){
  ...
  // POTENTIAL ENERGY //////////////////////////////////////////////////////////
  if (_measure_penergy){
    coutf.open("../OUTPUT/potential_energy_solid.dat",ios::app);
  ...
  // KINETIC ENERGY ////////////////////////////////////////////////////////////
  if (_measure_kenergy){
    coutf.open("../OUTPUT/kinetic_energy_solid.dat",ios::app);
  ...
  // TOTAL ENERGY //////////////////////////////////////////////////////////////
  if (_measure_tenergy){
    coutf.open("../OUTPUT/total_energy_solid.dat",ios::app);
  ...
  // TEMPERATURE ///////////////////////////////////////////////////////////////
  if (_measure_temp){
    coutf.open("../OUTPUT/temperature_solid.dat",ios::app);
  ...
  if (_measure_pressure){
    coutf.open("../OUTPUT/pressure_solid.dat",ios::app);
